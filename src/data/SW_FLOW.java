...
public class SW_FLOW {
	...
	public void SW_Water_Flow() {
		...
		if (Defines.EQ(SW_Soilwat.getSoilWat().snowpack[Today], 0.)) { /* litter interception only when no snow */
			p.litter_h2o_help = 0.;

			if (Defines.GT(SW_VegProd.getVegetationComposition().trees, 0.)) {
				litter_intercepted_water(SW_VegProd.getDailyValues().tree.litter_daily[doy], SW_VegProd.getVegetationComposition().trees, SW_VegProd.getVegetationInterceptionParameters().trees.a,
						SW_VegProd.getVegetationInterceptionParameters().trees.b, SW_VegProd.getVegetationInterceptionParameters().trees.c, SW_VegProd.getVegetationInterceptionParameters().trees.d);
				p.litter_h2o_help += p.litter_h2o;
			}

			if (Defines.GT(SW_VegProd.getVegetationComposition().shrubs, 0.)) {
				litter_intercepted_water(SW_VegProd.getDailyValues().shrub.litter_daily[doy], SW_VegProd.getVegetationComposition().shrubs, SW_VegProd.getVegetationInterceptionParameters().shrubs.a,
						SW_VegProd.getVegetationInterceptionParameters().shrubs.b, SW_VegProd.getVegetationInterceptionParameters().shrubs.c, SW_VegProd.getVegetationInterceptionParameters().shrubs.d);
				p.litter_h2o_help += p.litter_h2o;
			}

			if (Defines.GT(SW_VegProd.getVegetationComposition().forbs, 0.)) {
				litter_intercepted_water(SW_VegProd.getDailyValues().forb.litter_daily[doy], SW_VegProd.getVegetationComposition().forbs, SW_VegProd.getVegetationInterceptionParameters().forbs.a,
						SW_VegProd.getVegetationInterceptionParameters().forbs.b, SW_VegProd.getVegetationInterceptionParameters().forbs.c, SW_VegProd.getVegetationInterceptionParameters().forbs.d);
				p.litter_h2o_help += p.litter_h2o;
			}

			if (Defines.GT(SW_VegProd.getVegetationComposition().grasses, 0.)) {
				litter_intercepted_water(SW_VegProd.getDailyValues().grass.litter_daily[doy], SW_VegProd.getVegetationComposition().grasses, SW_VegProd.getVegetationInterceptionParameters().grasses.a,
						SW_VegProd.getVegetationInterceptionParameters().grasses.b, SW_VegProd.getVegetationInterceptionParameters().grasses.c, SW_VegProd.getVegetationInterceptionParameters().grasses.d);
				p.litter_h2o_help += p.litter_h2o;
			}
		...
		SW_Soilwat.getSoilWat().tree_int = p.tree_h2o;
		SW_Soilwat.getSoilWat().shrub_int = p.shrub_h2o;
		SW_Soilwat.getSoilWat().forb_int = p.forb_h2o;
		SW_Soilwat.getSoilWat().grass_int = p.grass_h2o;
		SW_Soilwat.getSoilWat().litter_int = p.litter_h2o;
		...
		/* PET */
		SW_Soilwat.getSoilWat().pet = SW_Site.getModel().coefficients.petMultiplier * petfunc(doy);

		/* Bare-soil evaporation rates */
		if (Defines.GT(SW_VegProd.getVegetationComposition().bareGround, 0.) && Defines.EQ(SW_Soilwat.getSoilWat().snowpack[Today], 0.)) /* bare ground present AND no snow on ground */
		{
